...
enum pin_cfg
{
    ...
    //lcdc
    MACRO_PIN_DEFINE(LCDC_VS_CS),
    MACRO_PIN_DEFINE(LCDC_HS_DC),
    MACRO_PIN_DEFINE(LCDC_DE_ERD),
    MACRO_PIN_DEFINE(LCDC_DOTCLK_RWR),
    MACRO_PIN_DEFINE(LCDC_D0),
    MACRO_PIN_DEFINE(LCDC_D1),
    MACRO_PIN_DEFINE(LCDC_D2),
    MACRO_PIN_DEFINE(LCDC_D3),
    MACRO_PIN_DEFINE(LCDC_D4),
    MACRO_PIN_DEFINE(LCDC_D5),
    MACRO_PIN_DEFINE(LCDC_D6),
    MACRO_PIN_DEFINE(LCDC_D7),
    MACRO_PIN_DEFINE(LCDC_D8),
    MACRO_PIN_DEFINE(LCDC_D9),
    MACRO_PIN_DEFINE(LCDC_D10),
    MACRO_PIN_DEFINE(LCDC_D11),
    MACRO_PIN_DEFINE(LCDC_D12),
    MACRO_PIN_DEFINE(LCDC_D13),
    MACRO_PIN_DEFINE(LCDC_D14),
    MACRO_PIN_DEFINE(LCDC_D15),
    MACRO_PIN_DEFINE(LCDC_D16),
    MACRO_PIN_DEFINE(LCDC_D17),
    MACRO_PIN_DEFINE(LCDC_D18),
    MACRO_PIN_DEFINE(LCDC_D19),
    MACRO_PIN_DEFINE(LCDC_D20),
    MACRO_PIN_DEFINE(LCDC_D21),
    MACRO_PIN_DEFINE(LCDC_D22),
    MACRO_PIN_DEFINE(LCDC_D23),
